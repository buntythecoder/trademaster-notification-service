 ...
 * - Rule #5: Interface Segregation - Small, focused interface
 * - Rule #2: Single Responsibility - Contract for agent integration only
 * - Rule #10: Dependency Inversion - Depend on abstractions
 *
