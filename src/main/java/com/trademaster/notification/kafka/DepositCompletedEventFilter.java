...
/**
 * Kafka Event Type Filter for DEPOSIT_COMPLETED events
 *
 ...
 * @version 1.0.0
 */
@Component("depositCompletedEventFilter")
@RequiredArgsConstructor
@Slf4j
public class DepositCompletedEventFilter implements org.springframework.kafka.listener.adapter.RecordFilterStrategy<String, String> {

    private final ObjectMapper objectMapper;

    @Override
    public boolean filter(org.apache.kafka.clients.consumer.ConsumerRecord<String, String> consumerRecord) {
        return !isEventType(consumerRecord.value(), "DEPOSIT_COMPLETED");
    }
