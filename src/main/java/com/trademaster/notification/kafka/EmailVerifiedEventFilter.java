...
/**
 * Kafka Event Type Filter for EMAIL_VERIFIED events
 *
 ...
 * @version 1.0.0
 */
@Component("emailVerifiedEventFilter")
@RequiredArgsConstructor
@Slf4j
public class EmailVerifiedEventFilter implements org.springframework.kafka.listener.adapter.RecordFilterStrategy<String, String> {

    private final ObjectMapper objectMapper;

    @Override
    public boolean filter(org.apache.kafka.clients.consumer.ConsumerRecord<String, String> consumerRecord) {
        return !isEventType(consumerRecord.value(), "EMAIL_VERIFIED");
    }
