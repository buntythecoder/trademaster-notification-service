...
/**
 * Kafka Event Type Filter for KYC_SUBMITTED events
 *
 ...
 * @version 1.0.0
 */
@Component("kycSubmittedEventFilter")
@RequiredArgsConstructor
@Slf4j
public class KycSubmittedEventFilter implements org.springframework.kafka.listener.adapter.RecordFilterStrategy<String, String> {

    private final ObjectMapper objectMapper;

    @Override
    public boolean filter(org.apache.kafka.clients.consumer.ConsumerRecord<String, String> consumerRecord) {
        return !isEventType(consumerRecord.value(), "KYC_SUBMITTED");
    }
