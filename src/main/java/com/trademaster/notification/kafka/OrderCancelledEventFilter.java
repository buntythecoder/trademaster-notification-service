...
/**
 * Kafka Event Type Filter for ORDER_CANCELLED events
 *
 ...
 * @version 1.0.0
 */
@Component("orderCancelledEventFilter")
@RequiredArgsConstructor
@Slf4j
public class OrderCancelledEventFilter implements org.springframework.kafka.listener.adapter.RecordFilterStrategy<String, String> {

    private final ObjectMapper objectMapper;

    @Override
    public boolean filter(org.apache.kafka.clients.consumer.ConsumerRecord<String, String> consumerRecord) {
        return !isEventType(consumerRecord.value(), "ORDER_CANCELLED");
    }
