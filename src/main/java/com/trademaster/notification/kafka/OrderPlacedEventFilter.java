...
/**
 * Kafka Event Type Filter for ORDER_PLACED events
 *
 ...
 * @version 1.0.0
 */
@Component("orderPlacedEventFilter")
@RequiredArgsConstructor
@Slf4j
public class OrderPlacedEventFilter implements org.springframework.kafka.listener.adapter.RecordFilterStrategy<String, String> {

    private final ObjectMapper objectMapper;

    @Override
    public boolean filter(org.apache.kafka.clients.consumer.ConsumerRecord<String, String> consumerRecord) {
        return !isEventType(consumerRecord.value(), "ORDER_PLACED");
    }
