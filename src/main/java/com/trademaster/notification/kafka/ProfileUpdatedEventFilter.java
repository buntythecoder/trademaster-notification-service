...
/**
 * Kafka Event Type Filter for PROFILE_UPDATED events
 *
 ...
 * @version 1.0.0
 */
@Component("profileUpdatedEventFilter")
@RequiredArgsConstructor
@Slf4j
public class ProfileUpdatedEventFilter implements org.springframework.kafka.listener.adapter.RecordFilterStrategy<String, String> {

    private final ObjectMapper objectMapper;

    @Override
    public boolean filter(org.apache.kafka.clients.consumer.ConsumerRecord<String, String> consumerRecord) {
        return !isEventType(consumerRecord.value(), "PROFILE_UPDATED");
    }
