...
@Component("twoFaEnabledEventFilter")
@RequiredArgsConstructor
@Slf4j
public class TwoFaEnabledEventFilter implements org.springframework.kafka.listener.adapter.RecordFilterStrategy<String, String> {

    private final ObjectMapper objectMapper;

    @Override
    public boolean filter(org.apache.kafka.clients.consumer.ConsumerRecord<String, String> consumerRecord) {
        return !isEventType(consumerRecord.value(), "TWO_FA_ENABLED");
    }
