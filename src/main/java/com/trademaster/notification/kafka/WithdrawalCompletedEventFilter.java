...
/**
 * Kafka Event Type Filter for WITHDRAWAL_COMPLETED events
 *
 ...
 * @version 1.0.0
 */
@Component("withdrawalCompletedEventFilter")
@RequiredArgsConstructor
@Slf4j
public class WithdrawalCompletedEventFilter implements org.springframework.kafka.listener.adapter.RecordFilterStrategy<String, String> {

    private final ObjectMapper objectMapper;

    @Override
    public boolean filter(org.apache.kafka.clients.consumer.ConsumerRecord<String, String> consumerRecord) {
        return !isEventType(consumerRecord.value(), "WITHDRAWAL_COMPLETED");
    }
